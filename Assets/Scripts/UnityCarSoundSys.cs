...
using Random = UnityEngine.Random;
    ...
    public class UnityCarSoundSys : MonoBehaviour
    {
        ...
        public CarSystemV2 m_CarController;
    ...
    private void FixedUpdate()
        {
            ...
            if (m_StartedSound)
            {
                ...
                // get values for fading the sounds based on the acceleration
                    ...
                    accFade = Mathf.Abs((m_CarController.m_AccelerationInput > 0 && !m_CarController.test ) ?m_CarController.m_AccelerationInput : 0);
